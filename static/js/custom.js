...
$(document).ready(function () {
  ...
  $(".add_hour").on("click", function (e) {
    ...
    if (eval(condition)) {
        ...
        success: function (response) {
          if (response.status == "Success") {
            if (response.is_closed == "Closed") {
              html = `<tr id=hour-${response.id}><td><strong>${response.day}</strong></td><td>Closed</td><td><a href='' class=remove_hour data-url=/opening_hours/remove/${response.id}>Remove</a></td></tr>`;
            } else {
              html = `<tr id=hour-${response.id}><td><strong>${response.day}</strong></td><td>${response.from_hour} to ${response.to_hour}</td><td><a href='' class=remove_hour data-url=/opening_hours/remove/${response.id}>Remove</a></td></tr>`;
            }
      ...
      swal({
        title: "Please fill all the relevant fields",
        text: "",
        icon: "info",
      });
    }
